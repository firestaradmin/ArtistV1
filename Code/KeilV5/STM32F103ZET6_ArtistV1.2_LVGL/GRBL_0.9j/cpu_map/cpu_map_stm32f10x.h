...
#define STEP_GPIO_CLK 				RCC_APB2Periph_GPIOC	//引脚时钟
#define	STEP_GPIO					GPIOC					//端口
#define	X_STEP_GPIO_PIN				GPIO_Pin_0				//引脚
#define	Y_STEP_GPIO_PIN				GPIO_Pin_2			   	//引脚
#define	Z_STEP_GPIO_PIN				GPIO_Pin_4				//引脚
//原平台适配，可不用修改。
#define X_STEP_BIT      			2  
#define Y_STEP_BIT      			3  
#define Z_STEP_BIT      			4  
...
#define DIRECTION_GPIO_CLK 				RCC_APB2Periph_GPIOC	//引脚时钟
#define	DIRECTION_GPIO					GPIOC					//端口
#define	X_DIRECTION_GPIO_PIN			GPIO_Pin_1				//引脚
#define	Y_DIRECTION_GPIO_PIN			GPIO_Pin_3			   	//引脚
...
//定义步进电机驱动器使能引脚
#define STEPPERS_DISABLE_GPIO_CLK		RCC_APB2Periph_GPIOA	//引脚时钟
#define STEPPERS_DISABLE_GPIO   		GPIOA					//端口
#define STEPPERS_DISABLE_GPIO_PIN		GPIO_Pin_1				//引脚
//原平台适配，可不用修改。
...
#define LIMIT_GPIO_CLK 				RCC_APB2Periph_GPIOB	//引脚时钟
#define	LIMIT_GPIO					GPIOB					//端口
#define	X_LIMIT_GPIO_PIN			GPIO_Pin_3				//引脚
#define Y_LIMIT_GPIO_PIN			GPIO_Pin_4			   	//引脚
#define	Z_LIMIT_GPIO_PIN			GPIO_Pin_5				//引脚

#define LIMIT_INT_PORTSOURCE 		GPIO_PortSourceGPIOB 	//中断源端口
#define X_LIMIT_INT_PINSOURCE		GPIO_PinSource3	   	//中断源引脚
#define Y_LIMIT_INT_PINSOURCE		GPIO_PinSource4		//中断源引脚
#define Z_LIMIT_INT_PINSOURCE		GPIO_PinSource5		//中断源引脚
#define X_LIMIT_INT_LINE			EXTI_Line3				//中断线
#define Y_LIMIT_INT_LINE			EXTI_Line4				//中断线
#define Z_LIMIT_INT_LINE			EXTI_Line5				//中断线

#define X_LIMIT_INT_CHANNEL			EXTI3_IRQn			//中断向量通道
#define Y_LIMIT_INT_CHANNEL			EXTI4_IRQn			//中断向量通道
#define Z_LIMIT_INT_CHANNEL			EXTI9_5_IRQn			//中断向量通道
//注意：中断处理函数需在代码中修改
...
//开启PWM控制主轴
  ...
  #define SPINDLE_PWM_GPIO_CLK		RCC_APB2Periph_GPIOB	//引脚时钟
  #define SPINDLE_PWM_GPIO   		GPIOB					//端口
  #define SPINDLE_PWM_GPIO_PIN		GPIO_Pin_12				//引脚
...
#define COOLANT_FLOOD_GPIO_PIN		GPIO_Pin_13				//引脚
